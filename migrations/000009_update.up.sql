...
CREATE TABLE IF NOT EXISTS WORKOUT_ACTION_HISTORY_NEW(
...
INSERT INTO WORKOUT_ACTION_HISTORY_NEW (id, action_id, reps, reps_unit, weight, weight_unit, remark, feedback, extra_medias, created_at, workout_day_id, student_id)
